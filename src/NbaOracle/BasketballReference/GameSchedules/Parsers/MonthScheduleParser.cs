    ...
    public class MonthScheduleParser : IDocumentParser<MonthScheduleData>
    {
        public MonthScheduleData Parse(IDocument document)
        {
            ...
            foreach (var game in games)
            {
                ...
                var homeTeam = game.GetAttributeFromElementAndTakeLeadingCharacters("td[data-stat='visitor_team_name']", "csk", 3);
                ...
                var gameWentToOvertime = game.GetTextContent("td[data-stat='overtimes']");
